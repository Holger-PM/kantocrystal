...
; Cerulean City events
	...
	const EVENT_COP_CERULEAN_1
	const EVENT_COP_CERULEAN_2
	const EVENT_ROCKET_CERULEAN_CITY
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_JAMES
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_HOPE
...
; Mt. Moon events
	...
	const EVENT_BEAT_MT_MOON_1F_BUG_CATCHER_NED
...
; New to Kanto Crystal
	...
	const EVENT_BEAT_COOLTRAINERF_HOLLY		; Route 6 EVENT_BEAT_COOLTRAINER_F_HOLLY
	const EVENT_BEAT_BUG_CATCHER_DAMON		; Route 6
	const EVENT_BEAT_BUG_CATCHER_MARCUS		; Route 6
	...
	const_next 2336 ; - New in "New to Kanto Crystal" section ???
