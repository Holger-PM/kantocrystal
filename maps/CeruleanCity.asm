...
;	scene_script CeruleanCityAfterRocketScene, SCENE_CERULEAN_CITY_BEFORE_BILL
	scene_script CeruleanCityAfterBillScene, SCENE_CERULEAN_CITY_AFTER_BILL ; Rocket can target player
...
CeruleanCityAfterBillScene: ; Rocket can target player
	end
...
CeruleanCity_MapEvents:
	...
	coord_event 30,  7, SCENE_CERULEAN_CITY_AFTER_BILL, CeruleanCityRocketScript
	...
	def_object_events
	object_event 20,  2, SPRITE_BLUE, SPRITEMOVEDATA_STANDING_DOWN, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_RIVAL_CERULEAN_CITY
	object_event 30,  8, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CeruleanCityRocketScript, EVENT_ROCKET_CERULEAN_CITY
	...
	object_event 27, 12, SPRITE_GUARD, SPRITEMOVEDATA_STANDING_DOWN, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeruleanCityCopScript, EVENT_COP_CERULEAN_1
	...
	object_event 28, 12, SPRITE_GUARD, SPRITEMOVEDATA_STANDING_DOWN, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CeruleanCityCopScript, EVENT_COP_CERULEAN_2
