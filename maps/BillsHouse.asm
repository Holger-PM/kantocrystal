...
.backtomain
	...
	clearevent EVENT_COP_CERULEAN_2
	clearevent EVENT_ROCKET_CERULEAN_CITY
	setevent EVENT_COP_CERULEAN_1 ; Is this remove the Cerulean City's cop 2 after meeting Bill ?
.ExplainSSAnne:
