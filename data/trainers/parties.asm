...
; 	db 42, GOLBAT, 42, MUK, 41, TENTACRUEL, 43, VENOMOTH, 0
;	db 49, GOLBAT, 48, MUK, 49, TENTACRUEL, 48, WEEZING, 50, VENOMOTH, 0
...
;	db  61, DRAGONITE, 60, GYARADOS, 60, CHARIZARD, 61, AERODACTYL, 62, DRAGONITE, 0
...
MistyGroup:
	...
	db 19, PSYDUCK,    SCRATCH, DISABLE, CONFUSION, BUBBLEBEAM
	db 18, GOLDEEN,    TAIL_WHIP, SUPERSONIC, HORN_ATTACK, WATERFALL
	db 21, STARMIE,    CONFUSION, BUBBLEBEAM, SWIFT, NO_MOVE
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 30, RAICHU,     THUNDER_WAVE, BODY_SLAM, THUNDERBOLT, SURF
	db -1 ; end
...
ErikaGroup:
	...
	db 34, TANGELA,   	STUN_SPORE, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 32, IVYSAUR,		ACID, LEECH_SEED, RAZOR_LEAF, NO_MOVE
	db 34, VICTREEBEL, 	GIGA_DRAIN, STUN_SPORE, ACID, RAZOR_LEAF
	db 37, VILEPLUME,  	ACID, SLEEP_POWDER, STUN_SPORE, SOLARBEAM
	db -1 ; end
...
;	db 43, ABRA,  42, MR_MIME, 43, KADABRA,  43, ALAKAZAM, 0
...
Blue2Group:
	...
	db 19, CHARMANDER,   $56, $56, NO_ITEM
	db -1 ; end
	
	; BLUE3_SQUIRTLE (2) Cerulean City
	db "?@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM
	db 18, PIDGEOTTO,    $34, $46, NO_ITEM
	db 15, RATTATA,      $56, $56, NO_ITEM
	db 15, ABRA,         $56, $56, NO_ITEM
	db 19, SQUIRTLE,     $56, $56, NO_ITEM
	db -1 ; end
	
	; BLUE3_BULBASAUR (3) Cerulean City
	db "?@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM
	db 18, PIDGEOTTO,    $34, $46, NO_ITEM
	db 15, RATTATA,      $56, $56, NO_ITEM
	db 15, ABRA,         $56, $56, NO_ITEM
	db 19, BULBASAUR,    $56, $56, NO_ITEM
	db -1 ; end
	
;;;;;;;;;; Holger note: TODO	
	; BLUE2  - SS Anne 2F
;	db 22, PIDGEOTTO,    $34, $46, NO_ITEM
;	db 20, RATICATE      $56, $56, NO_ITEM
;	db 21, KADABRA,      $56, $56, NO_ITEM
;	db 24, CHARMELEON,   $56, $56, NO_ITEM

	; BLUE2  - SS Anne 2F
;	db 22, PIDGEOTTO,    $34, $46, NO_ITEM
;	db 20, RATICATE      $56, $56, NO_ITEM
;	db 21, KADABRA,      $56, $56, NO_ITEM
;	db 24, WARTORTLE,    $56, $56, NO_ITEM

	; BLUE2  - SS Anne 2F
;	db 22, PIDGEOTTO,    $34, $46, NO_ITEM
;	db 20, RATICATE      $56, $56, NO_ITEM
;	db 21, KADABRA,      $56, $56, NO_ITEM
;	db 24, IVYSAUR,    $56, $56, NO_ITEM

;	; BLUE2 - Pokémon Tower 2F
...
TeamRocketGroup:
	; TEAM_ROCKET (1) - Mt. Moon B2F - TODO movepool
	db "@", TRAINERTYPE_MOVES
	db 16, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 15, EKANS,      WRAP, LEER, POISON_STING, BITE
	db 15, KOFFING,    POISON_GAS, TACKLE, SMOG, SMOKESCREEN
	db -1 ; end
	
	; TEAM_ROCKET (2) ; Rocket Hideout B4F - TODO movepool
	db "@", TRAINERTYPE_MOVES
	db 29, MEOWTH,     SCRATCH, GROWL, BITE, PAY_DAY
	db 28, ARBOK,      BITE, LEER, POISON_STING, GLARE
	db 28, KOFFING,    POISON_GAS, TACKLE, SMOG, TOXIC
	db -1 ; end
	
	; TEAM_ROCKET (3) ; Pokémon Tower 7F - TODO movepool
	db "@", TRAINERTYPE_MOVES
	db 33, MEOWTH,     GROWL, SCREECH, BITE, PAY_DAY
	db 31, ARBOK,      ACID, POISON_STING, WRAP, BITE
	db 30, LICKITUNG,  LICK, STOMP, HEADBUTT, NO_MOVE
	db 31, WEEZING,    SLUDGE, TACKLE, HAZE, SMOKESCREEN
	db -1 ; end
	
	; TEAM_ROCKET (4) ; Silph Co. 11F
	db "@", TRAINERTYPE_MOVES
	db 44, MEOWTH,     FURY_SWIPES, SCREECH, BITE, PAY_DAY
	db 42, ARBOK,      ACID, GLARE, WRAP, BITE
	db 41, LICKITUNG,  LICK, BODY_SLAM, HEADBUTT, NO_MOVE
	db 42, WEEZING,    SLUDGE, TACKLE, SELFDESTRUCT, SMOKESCREEN
	db 43, VICTREEBEL,
	db -1 ; end
