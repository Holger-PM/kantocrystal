...
;	const EVENT_BEAT_PEWTER_GYM_TRAINER_TONY ; Holger note - Not in gen 1
	const EVENT_GOT_TM34_BIDE
	const EVENT_BEAT_BROCK
	
; Cerulean City events
	const EVENT_RIVAL_CERULEAN_CITY ; Holger change
	const EVENT_COP_CERULEAN_1 ; Holger change
	const EVENT_COP_CERULEAN_2 ; Holger change
	const EVENT_ROCKET_CERULEAN_CITY ; Holger change
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_JAMES
	const EVENT_BEAT_CERULEAN_GYM_TRAINER_SHARON
;	const EVENT_BEAT_CERULEAN_GYM_TRAINER_LISA ; Holger note - Not gen 1
...
; Route 3 events
	const EVENT_BEAT_ROUTE_3_BUG_CATCHER_FREDDY
	const EVENT_BEAT_ROUTE_3_YOUNGSTER_BEN
	const EVENT_BEAT_ROUTE_3_LASS_MARISSA
	const EVENT_BEAT_ROUTE_3_BUG_CATCHER_ERICK
	const EVENT_BEAT_ROUTE_3_YOUNGSTER_GAVIN
	const EVENT_BEAT_ROUTE_3_LASS_AUDREY
	const EVENT_BEAT_ROUTE_3_BUG_CATCHER_WADE
	const EVENT_BEAT_ROUTE_3_LASS_PAIGE
	
; Route 4 events
	const EVENT_BEAT_ROUTE_4_COOLTRAINER_F2_GWEN
...
; Route 24 events
	...
	const EVENT_BEAT_ROUTE_24_CAMPER_SEAN
	const EVENT_BEAT_ROUTE_24_LASS_AMY
	const EVENT_BEAT_ROUTE_24_YOUNGSTER_RYAN
	const EVENT_BEAT_ROUTE_24_CAMPER_ALEX
	const EVENT_BEAT_ROUTE_24_LASS_EMILY
	const EVENT_BEAT_ROUTE_24_BUG_CATCHER_JAKE
	const EVENT_NUGGET_REWARD_AVAILABLE
	
; Route 25 events
	const EVENT_BEAT_ROUTE_25_HIKER_CLIFF
	const EVENT_BEAT_ROUTE_25_HIKER_RIDGE
	const EVENT_BEAT_ROUTE_25_YOUNGSTER_AIDEN
	const EVENT_BEAT_ROUTE_25_YOUNGSTER_WARREN
	const EVENT_BEAT_ROUTE_25_LASS_APRIL
	const EVENT_BEAT_ROUTE_25_HIKER_HANK
	const EVENT_BEAT_ROUTE_25_CAMPER_JEFFREY
	const EVENT_BEAT_ROUTE_25_YOUNGSTER_DEVIN
	const EVENT_BEAT_ROUTE_25_LASS_IRIS
	const_skip ; EVENT_ROUTE_25_HIDDEN_FAST_BALL
...
; Mt. Moon events
	...
	const EVENT_BEAT_MT_MOON_1F_BUG_CATCHER_KIP
	const EVENT_BEAT_MT_MOON_1F_LASS_SHANNON
	const EVENT_BEAT_MT_MOON_1F_YOUNGSTER_TOBY
	const EVENT_BEAT_MT_MOON_1F_HIKER_FLINT
...
; Juggler
	...
	const EVENT_BEAT_JUGGLER_CHESTER
	const EVENT_BEAT_JUGGLER_STANLEY
; Gentleman
...
; CooltrainerM
	...
	const EVENT_BEAT_COOLTRAINERM_BRODY 	; was TIMMY (unused)
	const EVENT_BEAT_COOLTRAINERM_TRAVIS 	; was ANDY (unused)
...
; Super Nerd
	...
	const EVENT_BEAT_SUPER_NERD_CONRAD
...
; Crystal-exclusive trainer flags
	...
	const_skip ; EVENT_BEAT_POKEFANM_REX - Removed from Route 6 
	const_skip ; EVENT_BEAT_POKEFANM_ALLAN - Removed from Route 6
...
; New to Kanto Crystal
	...
	const EVENT_BEAT_VIRIDIAN_FOREST_LASS_RACHEL ; Viridian Forest
	const EVENT_BEAT_BUG_CATCHER_WAYNE ; Viridian Forest
	const EVENT_BEAT_COOLTRAINERF_FELICIA	; Route 6
	const EVENT_BEAT_COOLTRAINERF_HOLLY		; Route 6
	const EVENT_BEAT_YOUNGSTER_DAMON		; Route 6
	const EVENT_BEAT_YOUNGSTER_MARCUS		; Route 6
	const EVENT_BEAT_YOUNGSTER_JESSE		; Route 11
	const EVENT_BEAT_YOUNGSTER_MASON		; Route 11
	const EVENT_BEAT_YOUNGSTER_CURTIS		; Route 11
	const EVENT_BEAT_YOUNGSTER_CHASE		; Route 11
	const EVENT_BEAT_JUGGLER_IRVING			; Route 11
	const EVENT_BEAT_SUPER_NERD_CEDRIC		; Route 11
	const EVENT_BEAT_GUITARIST_ZAKK			; Route 11
